    ...
    return (
        <div>
            ...
            <div className="w-full h-screen flex flex-col items-center pt-32">
                <input type="text" placeholder="Enter here" value={searchText} onChange={(e) => updateSeatch(e)} className="w-2/3 h-12 border-2 border-black pl-3" />
                <div className="w-1/5 flex justify-between mt-1 mb-1">
                    {filters.map((filter, index) => (
                        <div key={index} className="flex flex-col items-center p-2 border-2">
                            <p className="text-md">{filter.by}</p>
                            <input className="" type="checkbox" id={index} checked={filter.checked} onChange={() => {changeCheckbox(index)}}/>
                        </div>
                    ))}
                </div>
                ...
                <div className="w-4/5 h-full flex justify-center ">
                    {artists.length>0 && filters[0].checked && (
                        <div className="flex flex-col w-1/3">
                            <p className="text-2xl text-center pt-1 border-2 border-black">Artists</p>
                    ...
                    {songs.length>0 && filters[1].checked && (
                        <div className="flex flex-col w-1/3">
                            <p className="text-2xl text-center pt-1 border-2 border-black">Songs</p>
                    ...
                    {posts.length>0 && filters[2].checked && (
                        <div className="flex flex-col w-1/3">
                            <p className="text-2xl text-center pt-1 border-2 border-black">Posts</p>
